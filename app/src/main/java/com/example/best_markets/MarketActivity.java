...
//        c.close();
//        db1.close();
        market_name.setText("남대문 시장");
        market_intro.setText("숭례문 근처의 시장");
        market_name1.setText("망원 시장");
        market_intro1.setText("망원1동에 있는 재래시장");
        market_name2.setText("광장 시장");
        market_intro2.setText("조선시대 배오개시장 명맥을 이은 전통시장");

        market_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(getApplicationContext(), MarketListActivity.class); /////////////////////////////////
